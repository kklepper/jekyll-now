...
Investigating the bigger tables in my collection, I noticed a kind of key-value-store based on a primary key given by a md5 value. Right now there is no reason yet to partition this table, but in case it would make sense, the question was how to handle this case. It isn't hard to do:
